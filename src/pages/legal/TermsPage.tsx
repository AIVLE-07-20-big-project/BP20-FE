  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm leading-6 text-blue-950">
        Market Poke는 현재 관리자·점주 대상의 비공개 프로젝트 서비스이며 유료 결제와 고객용 주문 기능은 본 약관의 범위에 포함하지 않습니다.
      </div>

      <LegalSection title="제1조 (목적)"><p>본 약관은 {LEGAL_CONFIG.operatorName}(이하 “운영자”)가 제공하는 Market Poke 서비스의 이용 조건과 운영자 및 이용자의 권리·의무를 정함을 목적으로 합니다.</p></LegalSection>
